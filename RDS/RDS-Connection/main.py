...
def get_cpuutilization_alarms_to_create(rds_instances,
    ...
    for instance in rds_instances:
        ...
        cpu_utilization_alarm = MetricAlarm(
            name=u'RDS-{}-Too-Many-Connection'.format(
                instance[u'DBInstanceIdentifier']
            ),
            namespace=u'AWS/RDS',
            metric=u'DatabaseConnections', statistic='Average',
            comparison=u'>',
            threshold=0.80*((db_classes[instance[u'DBInstanceClass']]*1000000000)/9531392),
